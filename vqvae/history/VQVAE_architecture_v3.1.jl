...
function vq_distances(embedding::M, z_e::M) where {M<:AbstractMatrix{Float32}}
...
begin
    struct VQVAE{E,P,VQ,D}
        ...
        pre_vq::P          # Dense or 1x1 Conv: feature map/flat → latent vectors
...
function get_vqvae(para)
    ...
    # Shared Vector Quantizer (EMA) across slots.
