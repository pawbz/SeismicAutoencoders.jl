...
function training_backend(training_para::VQVAE_Training_Para)
    training_para.autodiff_backend === :zygote && return AutoZygote()
    training_para.autodiff_backend === :enzyme && return enzyme_training_backend()
    error("Unsupported autodiff_backend=$(training_para.autodiff_backend). Use :zygote or :enzyme.")
end
